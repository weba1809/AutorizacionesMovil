...
public class ExtendedSoapSerializationEnvelope extends SoapSerializationEnvelope {
    ...
    static {
        classNames.put("http://tempuri.org/^^objUsuario",objUsuario.class);
        classNames.put("http://tempuri.org/^^objAplicacion",objAplicacion.class);
        classNames.put("http://tempuri.org/^^objPermiso",objPermiso.class);
        classNames.put("http://tempuri.org/^^ArrayOfObjUsuario",ArrayOfObjUsuario.class);
        classNames.put("http://tempuri.org/^^ArrayOfObjAplicacion",ArrayOfObjAplicacion.class);
        classNames.put("http://tempuri.org/^^ArrayOfObjPermiso",ArrayOfObjPermiso.class);
    }   
